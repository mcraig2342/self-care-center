...
var mantraButton = document.querySelector(".mantra-bubble");
var affirmationButton = document.querySelector(".affirmation-bubble");
...
function showMessage() {
  if (mantraButton.checked === true) {
    outputMessage.innerText = mantras[getRandomIndex(mantras)];
    hideImage();

  } else if (affirmationButton.checked === true) {
    outputMessage.innerText = affirmations[getRandomIndex(affirmations)];
    hideImage();
  }
}
